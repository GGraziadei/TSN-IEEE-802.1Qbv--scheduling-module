...
ax[0,1].plot(app1_n_requests, app1_filtered['mean10_delay_app1'], label='App1 mean delay (window of 10)')
ax[0,1].plot(app1_n_requests, app1_filtered['mean_delay'], label='App1 mean delay')
