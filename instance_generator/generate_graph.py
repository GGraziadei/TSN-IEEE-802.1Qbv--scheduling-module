...
app1_n_requests = range(1, len(df['cumulative_max_delay_app1']) + 1)
app2_n_requests = range(1, len(df['cumulative_max_delay_app2']) + 1)

ax[0,1].plot(app1_n_requests, df['cumulative_max_delay_app1'], label='App1 cumulative max delay')
#ax[0,1].plot(app1_n_requests, app1_delay_mean, label='App1 cumulative mean delay')

ax[0,1].plot(app1_n_requests, df['cumulative_max_jitter_app1'], label='App1 cumulative max jitter')
ax[0,1].legend()
...
ax[1,1].plot(app2_n_requests, df['cumulative_max_delay_app2'], label='App2 cumulative max delay')
#ax[1,1].plot(app2_n_requests, app2_delay_mean, label='App2 cumulative mean delay')

ax[1,1].plot(app2_n_requests, df['cumulative_max_jitter_app2'], label='App2 cumulative max jitter')
ax[1,1].legend()
